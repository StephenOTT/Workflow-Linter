...
/**
 * Common Linting rules that are typically processors for larger chunk of rules that common from common sources such as YAML config of linting rules
 */
object CommonLinterRules {
